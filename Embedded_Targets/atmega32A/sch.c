...
*
* PRE-CONDITION: 187500 Hz > SCHED_FREQ > 3 Hz <br>
...
Sch_Init(void)
{
  ...
  TCCR1B = 0;
  TCCR1B |= 1 << WGM12;
  OCR1A = (SYSTEM_FREQ / PRESCALER / SCHED_FREQ) - 1;
  TIMSK |= 1 << OCIE1A;
}
...
* @code
* Sch_Init();
* // Make a task starting at 0 tick with period 10 ticks.
